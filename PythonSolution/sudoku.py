...
def is_valid(puzzle, guess, row, col):
    ...
    col_start = (col // 3) * 3 # Exact same logic for columns
    ...
    # If we get at thhis place, these checks pass => Validate
    return True
...
def solve_sudoku(puzzle);
    ...
    for guess in range(1, 10): 
        ...
        if is_valid(puzzle, guess, row, col):
            # step 5: if this is a valid guess, then place it at that spot on the puzzle
